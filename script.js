...
document.getElementById('typingInput').addEventListener('input', function(e) {
    ...
    switch(input) {
        case 'love':
            noteElement.innerHTML = "<p><strong>love:</strong>  I'm really happy I asked you that day, despite how cringey and panicked the whole thing was. I love you so much and promise to make it up and a lot more romantical for you:3 .</p>";
            break;
        case 'sweetheart':
            ...
            break;
        case 'scarlett':
            noteElement.innerHTML = "<p><strong>scarlett:</strong> That's you! I'm very glad that it was you that I met and asked</p>";
            break;
        case '22 september':
            ...
            break;
        case 'pink':
            noteElement.innerHTML = "<p><strong>pink:</strong>  Both of our favorite colours, hence why every gift you got today has an ongoing colour theme..</p>";
            break;
        case 'ellis':
